...
/* ============================================================================
   2. doGet ROUTER + TEMPLATE INCLUDE HELPER
   ============================================================================
   One deployed URL serves every "page" via a ?page= query param — each
   value maps to its own HTML template, navigated between with real (if
   ugly) URLs. See pageUrl() in JavaScript.html for how the client builds
   these links.
   ============================================================================ */
const PAGE_TEMPLATES = {
  login: 'Login',
  personal: 'AppPersonal',
  family: 'AppFamily',
