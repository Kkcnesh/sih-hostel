  ...
  const DOCUMENT_CONFIG = [
    ...
    { key: 'marksheets', serverDocType: 'Marksheets', label: 'Marksheets (12th or preceding semester)', required: true, accept: 'application/pdf', multiple: false, requiresPdf: true,
      help: 'Neat and Scanned - (PDF)' },
